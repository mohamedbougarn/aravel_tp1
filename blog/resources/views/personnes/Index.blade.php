...
@section('content')
 ...
 <a class="btn btnsuccess" href="/create" title="Create a Personne"> <i class="fas fa-pluscircle"></i>
 </a>
 </div></div></div>
...
<form action="/" method="POST">
 ...
 <a href="/destroy/{{$Personne->id}}"> <i class="fas fa-trash falg text-danger"></i></a>
 @csrf
@method('DELETE')
